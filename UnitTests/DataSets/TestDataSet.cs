...
namespace UnitTests
{
    public abstract class TestDataSet : IMediaSequences
    {
        ...
        /// Private Data Set
        /// </summary>
        protected static readonly string TEST_BASE_DIRECTORY = "../../media";
        ...
        public abstract IEnumerable<IMediaSequence> getMediaSequences();
