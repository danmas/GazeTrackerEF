...
{
    public class LazyLoadImageMediaFrame : BaseMediaFrame
    {
        ...
        public LazyLoadImageMediaFrame( string imageFilename, IEnumerable<ILabelledFeature> labelledFeatures ) : base( labelledFeatures )
        {
