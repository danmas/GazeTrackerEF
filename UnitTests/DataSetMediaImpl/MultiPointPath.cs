...
{
    public class MultiPointPath : IPath
    {
        ...
        public MultiPointPath( Point[] points, bool isClosed )
        {
            _points = points;
            _isClosed = isClosed;
        }

        protected MultiPointPath()
        {
            // Only subclasses can create with no constructor
        }
